...
save(res_model_wingbugs, file = "material/resmod1")
```
...
spatial_data$RME <- res.mod1$mean$R
spatial_data$p.RME <- res.mod1$mean$p.R
```
...
Datos_medias <- data.frame("winbugs" = res_model_wingbugs$mean$R, "INLA" = spatial_model_inla$summary.fitted.values$mean)
